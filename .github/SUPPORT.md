# Getting help with ncdc_storm_events

Thanks for using ncdc_storm_events. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/timtrice/ncdc_storm_events/issues) to make sure the 

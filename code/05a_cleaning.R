...
details_dates[, (cols) := lapply(.SD, str_pad, width = 2L, side = "left", pad = "0"), .SDcols = cols]
cols <- c("BEGIN_TIME", "END_TIME")
details_dates[, (cols) := lapply(.SD, str_pad, width = 4L, side = "left", pad = "0"), .SDcols = cols]

# ---- details-dates-date-time-identicality ----
details_dates[,
        `:=`(
          BEGIN_DATE_TIME_PASTED = paste(
            paste(
              ...
              substr(x = details_dates$BEGIN_YEARMONTH, start = 3L, stop = 4L),
              sep = "-"),
            paste(
              substr(x = details_dates$BEGIN_TIME, start = 1L, stop = 2L),
              substr(x = details_dates$BEGIN_TIME, start = 3L, stop = 4L),
              "00",
              sep = ":"
            ),
            sep = " "),
          END_DATE_TIME_PASTED = paste(
            paste(
              ...
              substr(x = details_dates$END_YEARMONTH, start = 3L, stop = 4L),
              sep = "-"),
            paste(
              substr(x = details_dates$END_TIME, start = 1L, stop = 2L),
              substr(x = details_dates$END_TIME, start = 3L, stop = 4L),
              "00",
              sep = ":"
            ),
            sep = " ")
...
# ---- details-lat-lon-read, cache = TRUE ----

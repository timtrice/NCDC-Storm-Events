...
#' @return df[,c("EVENT_ID", ["DAMAGE_PROPERTY"|"DAMAGE_CROPS"])]
#' @export
...
#' @param df[,c("EVENT_ID", "[BEGIN|END]_YEARMONTH", "[BEGIN|END]_DAY", "[BEGIN|END]_DATE_TIME")]
#' @return df[,c("EVENT_ID", "[BEGIN|END]_DATE_TIME")] with the datetime value in '%Y-%m-%d %T' format.
#' @export
...
#' details.
#' 
#' A warning will be generated by tidyr::separate as most `EVENT_TYPE` only 
#' contain one value; the warning is advising us of this and can be ignored.
#' @param df[,c("EVENT_ID", "EVENT_TYPE")]
#' @return TRUE on success
#' @export
...
#' @param df[,c("EVENT_ID", "FLOOD_CAUSE")]
